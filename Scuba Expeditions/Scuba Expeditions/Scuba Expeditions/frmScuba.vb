...
' Author:       Josh Nichols
' Date:         March 29, 2022
' Purpose:      The Scuba Expeditions app determines the location and suba dives available and calculates the total dive team cost. 
...
Public Class frmScuba
    ...
    Private Function FijiDiveCost(ByVal intDive As Integer, ByVal intTeam As Integer, ByRef intTime As Integer) As Decimal
        ...
        Dim decTeamCost As Decimal
        Dim decFinalCost As Decimal
        Dim decFijiDive2 As Decimal = 250D
